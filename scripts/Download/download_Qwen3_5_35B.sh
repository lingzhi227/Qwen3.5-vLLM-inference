#!/bin/bash
# =============================================================================
# Download Qwen3.5-35B model to local pscratch
# Run on login node (has internet). No GPU needed.
# Usage: bash scripts/step-0-download/download_Qwen3_5_35B.sh
# =============================================================================
set -euo pipefail

MODEL="Qwen/Qwen3.5-35B-A3B"
LOCAL_MODEL_DIR="/pscratch/sd/l/lingzhi/models/Qwen3.5-35B-A3B"
VLLM_IMAGE="vllm/vllm-openai:latest"

echo "Downloading $MODEL to $LOCAL_MODEL_DIR ..."
echo "This will download ~70 GB. Progress will be shown below."
echo ""
